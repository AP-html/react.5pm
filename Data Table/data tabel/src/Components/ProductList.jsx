...
export const ProductList = () => {
  ...
  return (
    <div>
      <h2 style={{ backgroundColor: "#ADD899" }}>Product List</h2>
      ...
      >
        {products.map((el) => (
          <div key={el.id} style={{minWidth:"100%",border:"1px solid black",boxShadow:"0px 6px 6px rgba(0,0,0,0.25)", height:"600px",padding:"10px"}}>
            ...
            <Link to={`/ProductDetails/${el.id}`} style={{backgroundColor:"#F075AA",color:"black",textDecoration:"none",padding:"5px 30px",border:"1px solid black"}}>Buy Item</Link><br /><br />
          </div>
        ))}
      </div>
      <br />
