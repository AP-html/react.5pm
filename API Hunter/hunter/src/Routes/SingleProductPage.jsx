...
function SingleProductPage(){
    ...
    return (
        ...
        <div data-testid="products-container" style={{height:"500px",backgroundColor:"white",width:"50%",marginLeft:"25%",borderRadius:"20px",boxShadow:" 5px 5px 5px 5px lightred"}}>   
            <div>
